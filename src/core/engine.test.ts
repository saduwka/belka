...
import { createDeck, determineTrickWinner, validateMove, isTrump, getCardPower, sortHand } from './engine';
...
describe('Belka Engine Logic', () => {
  ...
  it('validates Ace discard rule', () => {
    ...
    // Cannot discard Bare Ace if you have other cards (that are not trumps and not forced)
    // Actually, in our engine, it checks playedSuits.
